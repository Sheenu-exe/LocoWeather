...
async function getWeatherByLocation(city){
      ...
      function addWeatherToPage(data){
          ...
          weather.innerHTML = `
          <h2 id="weather"><img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png" /> ${temp}°C <img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png" /></h2>
          <small id="small">${data.weather[0].main}</small>
